...
import { RegistrationItem } from '../lecturer-selection.models';

@Component({
  selector: 'app-lecturer-registration-card',
  standalone: true,
  imports: [CommonModule, LucideAngularModule],
  templateUrl: './lecturer-registration-card.component.html',
})
export class LecturerRegistrationCardComponent {
  @Input({ required: true }) item!: RegistrationItem;
  @Input() saving = false;
  @Output() register = new EventEmitter<RegistrationItem>();
